...
Ez egy olyan alapértelmezett értéket biztosító operátor, amely visszaadja a jobb oldali operandust,
ha a bal oldali operandus szigorúan null vagy undefined (ezek a "nullish" értékek).
Minden más esetben a bal oldali értéket tartja meg.
